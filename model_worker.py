...
from native_config import normalize_config,write_config
...
if __name__=='__main__':
    ...
    args=p.parse_args();request=json.loads(args.request.read_text('utf-8'));config=normalize_config(request['config'])
