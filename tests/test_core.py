import unittest
from core import Catalog, Presentation, display_text


class CoreTests(unittest.TestCase):
    def setUp(self):
        self.catalog = Catalog({'version': 1, 'entries': [
            {'key': 'a', 'texts': {'zh-Hans': '早上好。', 'ja': 'おはよう。', 'en': 'Good morning.'}},
    ...
    def test_markup_whitespace_match(self):
        self.assertEqual(self.catalog.lookup('<c>早上\n好。</c>', 'en', 'ja')[0],
                         ('Good morning.', 'おはよう。'))
