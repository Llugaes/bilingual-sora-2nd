...
GROUPS = {
    "ui": (
        ...
        "sora_bilingual/game/install.py",
        "sora_bilingual/fonts/font_delivery.py",
        "sora_bilingual/fonts/install_font_patch.py",
        "sora_bilingual/fonts/universal_fonts.py",
        "sora_bilingual/fonts/font_merge.py",
